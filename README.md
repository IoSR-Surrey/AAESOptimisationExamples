...
<div style="display:flex;flex-direction:row;gap:16px;align-items:stretch;">
  ...
  <div style="display:flex;flex-direction:column;gap:8px;">
    ...
    <div style="display:flex;flex-direction:column;justify-content:flex-start;">
      <div>
        <h4 style="margin:0 0 16px 0;">Passive Room</h4>
        <audio controls>
      ...
      <div>
        <h4 style="margin:0 0 16px 0;">a. No Equalisation</h4>
        <audio controls>
      ...
      <div>
        <h4 style="margin:0 0 16px 0;">b. Optimised (Open-Loop)</h4>
        <audio controls>
      ...
      <div>
        <h4 style="margin:0 0 16px 0;">c. Optimised (Closed-Loop)</h4>
        <audio controls>
...
<div style="display:flex;flex-direction:row;gap:16px;align-items:stretch;">
  ...
  <div style="display:flex;flex-direction:column;gap:8px;">
    ...
    <div style="display:flex;flex-direction:column;justify-content:flex-start;">
      <div>
        <h4 style="margin:0 0 16px 0;">a. Passive Room</h4>
        <audio controls>
      ...
      <div>
        <h4 style="margin:0 0 16px 0;">b. Target</h4>
        <audio controls>
      ...
      <div>
        <h4 style="margin:0 0 16px 0;">c. Optimised</h4>
        <audio controls>
      ...
      <div>
        <h4 style="margin:0 0 16px 0;">Optimised (modified*)</h4>
        <audio controls>
